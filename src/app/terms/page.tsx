...
// Versão INGLESA dos termos de uso. A principal é a portuguesa (/termos).
// As duas dizem a mesma coisa — ao mudar uma, mudar a outra.
    ...
    >
      <div className="privacy-box">
        ...
        <p>
          ...
          call <b>999</b> or <b>112</b> — both work in Ireland and in the United
          Kingdom. The app does not call the police for you, and no one on the
          other side is on duty reading the alerts.
        </p>
      </div>
      ...
      <p>
        ...
        governed by the law of Ireland. If you live in the United Kingdom or in
        another country, this does not remove the mandatory consumer protections
        of the place where you live, and you may still bring proceedings before
        your local courts.
      </p>
